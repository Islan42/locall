...
def index(request):
    ...
    num_romances = Book.objects.filter(title__icontains='romance').count()
...
def allBorrowedBooks(request):
    ...
    context = {'all_borrowed': all_borrowed, }
...
# from catalog.forms import CreateBookModelForm
# from catalog.forms import UpdateBookModelForm
# from catalog.forms import DeleteBookModelForm
    ...
    # if request.method == 'POST':
        ...
        # if form.is_valid():
            # record = Book(
                ...
                # genre=form.cleaned_data['genre'].set(),
